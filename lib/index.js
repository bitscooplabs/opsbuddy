		...
		Promise.resolve()
			...
			.then(function() {
				...
				if (accessToken) {
					...
					self.emit(':tellWithLinkAccountCard', 'To start using this skill, please use the companion app to authenticate with the Google account you used to sign up for your Ops Buddy account.');
				}
			})
