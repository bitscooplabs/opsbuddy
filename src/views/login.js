	...
	return Promise.resolve()
		...
		.then(function() {
			...
			return bitscoop.createConnection(mapId, {
				redirect_url: process.env.SITE_URL + '/complete-login?type=login'
			});
		})
		.then(function(result) {
			...
			let cookieString = 'social_demo_session_id=' + token + '; domain=' + siteDomain + '; expires=' + expiration + '; secure=true; http_only=true';
